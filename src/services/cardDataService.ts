...
export const SECTION_CARD_TITLES = {
    crecimiento: [
        ...
        "VALOR DEUDA", "CRECIMIENTO PATRIMONIO", "CREACION DE VALOR", "VENTAS", "RENTABILIDAD PATRIMONIO", "RENTABILIDAD CAPITAL"
    ],
    riesgo: [
    ...
    rentabilidad: [
        "UTILIDAD NETA", "ROTACION DE ACTIVOS", "PALANCA FINANCIERA"
    ],
    inversiones: [
